...
public class UserServiceImpl extends BaseService implements UserService {
    ...
    public boolean addUser(String thirdType, String thirdId, String nickname, String logo, String recommendOpenid)
	...
	if (userDAO.addUser(thirdType, thirdId, nickname, logo, recommendOpenid, balance) == 0) {
