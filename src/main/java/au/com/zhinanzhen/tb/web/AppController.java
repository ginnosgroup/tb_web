...
public class AppController extends AbstractController {
    ...
    @ResponseBody
    public JsonResult appRegist(String openId,String thirdType,String nickName,String logUrl,String recommendOpenid) throws ServiceException {
	...
	if(!userService.addUser(ThirdTypeEnum.WECHAT.toString(), openId, nickName, logUrl, recommendOpenid)){
